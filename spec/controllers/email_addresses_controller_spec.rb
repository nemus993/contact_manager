...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) {
    {address: "123@example.com", person_id: 1}
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the emails person" do
        post :create, {:email_address => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes){{address: "alice@example.com", person_id: alice.id}}
      let(:new_attributes) {
        {address: "new@example.com", person_id: alice.id}
      }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eq("new@example.com")
